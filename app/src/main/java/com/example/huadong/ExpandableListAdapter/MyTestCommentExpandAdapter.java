...
//
//public class MyTestCommentExpandAdapter extends BaseExpandableListAdapter {
//    private Context context;
//    private List<CommentInfo> commentInfo_list;
//    private List<ReplyInfo> replyInfo_list;
//    public MyTestCommentExpandAdapter(Context context, List<CommentInfo> commentInfo_list,List<ReplyInfo> replyInfo_list){
//        this.context=context;
//        this.commentInfo_list=commentInfo_list;
//        this.replyInfo_list=replyInfo_list;
//    }
//    @Override
//    public int getGroupCount() {
//        return commentInfo_list.size();
//    }
//
//    @Override
//    public int getChildrenCount(int groupPosition) {
//        if(replyInfo_list == null){
//            return 0;
//        }else {
//            return replyInfo_list.size() > 0 ? replyInfo_list.size() : 0;
//        }
//    }
//
//    @Override
...
//
//        return commentInfo_list.get(groupPosition);
//    }
//
//    @Override
//    public Object getChild(int groupPosition, int childPosition) {
//        //返回group中某个child的实际数据，这里指的是当前评论的某个回复数据
//        return replyInfo_list.get(childPosition);
//    }
//
//    @Override
...
//        CommentExpandAdapt.GroupView groupView;
//        if(convertView==null){
//            convertView= LayoutInflater.from(context).inflate(R.layout.expand_comment_item,parent,false);
//            groupView= new MyTestCommentExpandAdapter.GroupView(convertView);
//            convertView.setTag(groupView);
//        }else{
//            groupView = (CommentExpandAdapt.GroupView) convertView.getTag();
//        }
...
//        CommentExpandAdapt.ChildView childView;
//        if(convertView==null){
//            convertView =LayoutInflater.from(context).inflate(R.layout.expand_comment_reply_item,parent,false);
//            childView = new CommentExpandAdapt.ChildView(convertView);
//            convertView.setTag(childView);
//        }else{
//            childView =(CommentExpandAdapt.ChildView) convertView.getTag();
//        }
...
//        }
//        CommentDetailBean commentDetailBean = list.get(groupPosition);
...
//        childView.tv_name.setText(commentDetailBean.getReplyList().get(childPosition).getNickName());
//        childView.tv_content.setText(commentDetailBean.getReplyList().get(childPosition).getContent());
//        return convertView;
//    }
//
//    @Override
...
//            Log.d("commentDetailBean",commentDetailBean.toString());
